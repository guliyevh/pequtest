...
program define pequtest
    ...
    scalar N_m = e(N)  // Number of observations from the first model
    ...
    // Display the header for the individual equality test
    di as text "Individual Equality Test:"
    ...
    di as text "Jointly Equality Test:"
