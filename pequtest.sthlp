{smcl}
{* *! version 1.0.0 20feb2025 Hasraddin Guliyev}{...}
...
{p 4 4 2}
The individual equality test examines each independent variable separately, while the jointly equality test evaluates whether all coefficients are jointly equal across the two models. This command is particularly useful in contexts such as:
